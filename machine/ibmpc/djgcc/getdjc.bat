...
echo from a working directory you specify into this DJGCC directory,
echo as well as the IBMPC and SOURCE directories
echo For example: "GETDJC C:\POVWORK" copies files from 
...
echo :Over >> tcopy.bat
rem
call tcopy %1\IBMGCC.MAK  ibmgcc.mak
call tcopy %1\IBMGCC.LNK  ibmgcc.lnk
