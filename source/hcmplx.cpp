 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.6-release/source/hcmplx.cpp $
 * $Revision: #2 $
 * $Change: 2939 $
...
static CMPLX exponent = {0,0}; // GLOBAL VARIABLE
...
void Normal_Calc_HCompl(VECTOR Result, int N_Max, FRACTAL *)
{
  DBL n1, n2, n3, n4;
  int i;
  DBL x, y, z, w;
...
void Normal_Calc_HCompl_z3(VECTOR Result, int N_Max, FRACTAL *)
{
  DBL n1, n2, n3, n4;
  int i;
  DBL x, y, z, w;
...
void Normal_Calc_HCompl_Reciprocal(VECTOR Result, int N_Max, FRACTAL *)
{
  DBL n1, n2, n3, n4;
  int i;
  DBL x, y, z, w;
