...
long numberOfFiniteObjects, numberOfInfiniteObjects;
...
void Build_Bounding_Slabs(BBOX_TREE **Root)
{
  ...
  numberOfFiniteObjects = numberOfInfiniteObjects = 0;
  ...
  Render_Info("\nScene contains %ld frame level objects; %ld infinite.\n",
      numberOfFiniteObjects + numberOfInfiniteObjects, numberOfInfiniteObjects);
