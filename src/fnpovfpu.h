...
*
* $File: //depot/povray/3.5/source/fnpovfpu.h $
* $Revision: #27 $
* $Change: 1817 $
...
#define OPCODE_NOP    OPCODE(15,7,7)

extern Opcode POVFPU_Opcodes[];

extern Sys1 POVFPU_Sys1Table[];
extern Sys2 POVFPU_Sys2Table[];

extern unsigned int POVFPU_Sys1TableSize;
extern unsigned int POVFPU_Sys2TableSize;
